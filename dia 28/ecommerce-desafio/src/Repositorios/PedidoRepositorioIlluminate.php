<?php 
namespace Douglas\EcommerceDesafio\Repositorios;

use Douglas\EcommerceDesafio\Repositorios\Infraestrutura\IlluminateRepositorio;
use Douglas\EcommerceDesafio\Repositorios\Interfaces\IRepositorio;
use Douglas\EcommerceDesafio\Models\Pedido;
...
class PedidoRepositorioIlluminate implements IRepositorio {
    ...
    public function buscar($params=[], $pagina=1, $totalPagina=7) : array {
