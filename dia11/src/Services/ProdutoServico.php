<?php
namespace Desafio\CadastroProduto\Core\entidades;

use Desafio\CadastroProduto\Core\entidades;
use Desafio\CadastroProduto\Database\Repositorios\MysqlRepositorio;
