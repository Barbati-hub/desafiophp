<?php
namespace Desafio\CadastroProduto\Display;

use Desafio\CadastroProduto\Core\Entidades\Produto;
use Desafio\CadastroProduto\Display\Usabilidade;
use Desafio\CadastroProduto\Core\Servicos\ProdutoServico;
